...
${OBJECTDIR}/LabeledGraph.o: LabeledGraph.cxx
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LabeledGraph.o LabeledGraph.cxx

${OBJECTDIR}/LabeledGraphQueryClient.o: LabeledGraphQueryClient.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LabeledGraphQueryClient.o LabeledGraphQueryClient.cpp

${OBJECTDIR}/PersonalityHistogram.o: PersonalityHistogram.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonalityHistogram.o PersonalityHistogram.cpp
...
${TESTDIR}/TestDestination.o: TestDestination.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/TestDestination.o TestDestination.cpp
...
${OBJECTDIR}/LabeledGraph_nomain.o: ${OBJECTDIR}/LabeledGraph.o LabeledGraph.cxx 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LabeledGraph_nomain.o LabeledGraph.cxx;\
	else  \
...
${OBJECTDIR}/LabeledGraphQueryClient_nomain.o: ${OBJECTDIR}/LabeledGraphQueryClient.o LabeledGraphQueryClient.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LabeledGraphQueryClient_nomain.o LabeledGraphQueryClient.cpp;\
	else  \
...
${OBJECTDIR}/PersonalityHistogram_nomain.o: ${OBJECTDIR}/PersonalityHistogram.o PersonalityHistogram.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PersonalityHistogram_nomain.o PersonalityHistogram.cpp;\
	else  \
